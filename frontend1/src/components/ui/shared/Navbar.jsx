...
// //                     <p className="font-semibold">Sinha Mern Stack</p>
...
import { setUser } from '@/redux/authSlice';
import { toast } from 'react-toastify';
import axios from 'axios'; // ✅ Important: You forgot to import axios!
        ...
        <div className='flex items-center gap-12'>
          ...
          {isLoggedIn ? (
            <div className="relative">
              ...
              >
                <img
                  src={user?.profile?.profilePhoto} // ✅ use real user avatar if available
                  alt="User Avatar"
                  className="h-full w-full object-cover rounded-full"
                />
              </div>
              ...
              {showDropdown && (
                <div className="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-lg p-2 z-50">
                  ...
                  <Link to="/profile">
                    <Button className="flex items-center w-full gap-2 px-4 py-2 text-sm font-semibold text-gray-800 bg-gray-100 hover:bg-blue-100 hover:text-blue-600 hover:opacity-95 transition-all duration-200 rounded-md"
                    >
                      <UserRound className="h-4 w-4" />
                      View Profile
                    </Button>
                  ...
                  <Button
                    onClick={logoutHandler}
                    className="flex items-center w-full gap-2 px-4 py-2 text-sm font-semibold text-white bg-red-500 hover:bg-red-600 hover:opacity-95 transition-all duration-200 rounded-md"
